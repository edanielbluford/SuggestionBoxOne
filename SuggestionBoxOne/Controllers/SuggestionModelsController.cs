...
using SuggestionBoxOne.Models;

namespace SuggestionBoxOne.Controllers
{
    public class SuggestionModelsController : Controller
    {
        private SuggestionBoxOneContext db = new SuggestionBoxOneContext();
        ...
        public ActionResult Create([Bind(Include = "RecordNum,SuggestionName,SuggestionComment")] SuggestionModel suggestionModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecordNum,SuggestionName,SuggestionComment")] SuggestionModel suggestionModel)
        {
            if (ModelState.IsValid)
            {
